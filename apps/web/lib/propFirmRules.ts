...
Apex Trader Funding|PA / funded (intraday)|25000|1000|INTRADAY|0|0|4.0 funded. Threshold stops at start + $100, reached when your peak balance is start + drawdown + $100. Platform does not matter on funded accounts. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $26,100 (drawdown + $100) must be held for the life of the account; $26,600 to request a payout.|25100|2
Apex Trader Funding|PA / funded (intraday)|50000|2000|INTRADAY|0|0|4.0 funded. Threshold stops at start + $100, reached when your peak balance is start + drawdown + $100. Platform does not matter on funded accounts. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $52,100 (drawdown + $100) must be held for the life of the account; $52,600 to request a payout.|50100|4
Apex Trader Funding|PA / funded (intraday)|100000|3000|INTRADAY|0|0|4.0 funded. Threshold stops at start + $100, reached when your peak balance is start + drawdown + $100. Platform does not matter on funded accounts. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $103,100 (drawdown + $100) must be held for the life of the account; $103,600 to request a payout.|100100|6
Apex Trader Funding|PA / funded (intraday)|150000|4000|INTRADAY|0|0|4.0 funded. Threshold stops at start + $100, reached when your peak balance is start + drawdown + $100. Platform does not matter on funded accounts. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $154,100 (drawdown + $100) must be held for the life of the account; $154,600 to request a payout.|150100|10
Apex Trader Funding|PA / funded (end-of-day)|25000|1000|EOD|0|0|4.0 funded. Threshold stops at start + $100. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $26,100 (drawdown + $100) must be held for the life of the account; $26,600 to request a payout.|25100|2
Apex Trader Funding|PA / funded (end-of-day)|50000|2000|EOD|0|0|4.0 funded. Threshold stops at start + $100. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $52,100 (drawdown + $100) must be held for the life of the account; $52,600 to request a payout.|50100|4
Apex Trader Funding|PA / funded (end-of-day)|100000|3000|EOD|0|0|4.0 funded. Threshold stops at start + $100. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $103,100 (drawdown + $100) must be held for the life of the account; $103,600 to request a payout.|100100|6
Apex Trader Funding|PA / funded (end-of-day)|150000|4000|EOD|0|0|4.0 funded. Threshold stops at start + $100. Apex sets a TIER-BASED daily loss limit - read yours off your dashboard and type it in. Safety Net $154,100 (drawdown + $100) must be held for the life of the account; $154,600 to request a payout.|150100|10
...
Apex Trader Funding|Legacy PA / funded|25000|1500|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|25100|4
Apex Trader Funding|Legacy PA / funded|50000|2500|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|50100|10
Apex Trader Funding|Legacy PA / funded|75000|2750|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|75100|12
Apex Trader Funding|Legacy PA / funded|100000|3000|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|100100|14
Apex Trader Funding|Legacy PA / funded|150000|5000|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|150100|17
Apex Trader Funding|Legacy PA / funded|250000|6500|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|250100|27
Apex Trader Funding|Legacy PA / funded|300000|7500|INTRADAY|0|0|Legacy funded. Threshold stops rising at starting balance + $100. Legacy safety net and payout minimum NOT verified - check your dashboard.|300100|35
...
MyFundedFutures|Builder|50000|2000|EOD|1000|3000|$1,000 soft-pause daily loss; $1,500 max-loss option at checkout. MyFundedFutures: the Max EOD trailing "locks in at $100 plus the initial starting balance", reached when your balance is start + drawdown + $100.|50100
MyFundedFutures|Rapid (intraday)|25000|1000|INTRADAY|0|1500|Trail updates on every new equity high during the session. The limit "will not exceed the starting balance" - so it locks at $25,000, NOT start + $100. That is MyFundedFutures' intraday rule; their EOD accounts do use start + $100.|25000
MyFundedFutures|Rapid (intraday)|50000|2000|INTRADAY|0|3000|Trail updates on every new equity high during the session. The limit "will not exceed the starting balance" - so it locks at $50,000, NOT start + $100. That is MyFundedFutures' intraday rule; their EOD accounts do use start + $100.|50000
MyFundedFutures|Rapid (intraday)|100000|3000|INTRADAY|0|6000|Trail updates on every new equity high during the session. The limit "will not exceed the starting balance" - so it locks at $100,000, NOT start + $100. That is MyFundedFutures' intraday rule; their EOD accounts do use start + $100.|100000
MyFundedFutures|Rapid (intraday)|150000|4500|INTRADAY|0|9000|Trail updates on every new equity high during the session. The limit "will not exceed the starting balance" - so it locks at $150,000, NOT start + $100. That is MyFundedFutures' intraday rule; their EOD accounts do use start + $100.|150000
MyFundedFutures|Pro (EOD)|50000|2000|EOD|0|3000|End-of-day trailing. MyFundedFutures: the Max EOD trailing "locks in at $100 plus the initial starting balance", reached when your balance is start + drawdown + $100.|50100
MyFundedFutures|Pro (EOD)|100000|3000|EOD|0|6000|End-of-day trailing. MyFundedFutures: the Max EOD trailing "locks in at $100 plus the initial starting balance", reached when your balance is start + drawdown + $100.|100100
MyFundedFutures|Pro (EOD)|150000|4500|EOD|0|9000|End-of-day trailing. MyFundedFutures: the Max EOD trailing "locks in at $100 plus the initial starting balance", reached when your balance is start + drawdown + $100.|150100
MyFundedFutures|Core (legacy)|50000|1500|EOD|0|3000|Legacy plan - verify, no longer sold.|50100
MyFundedFutures|Flex (legacy, static)|25000|1000|EOD|0|0|Legacy STATIC drawdown - the floor never moves and sits below the start, at $24,000. No longer sold; verify.|24000
MyFundedFutures|Flex (legacy, static)|50000|2000|EOD|0|0|Legacy STATIC drawdown - the floor never moves and sits below the start, at $48,000. No longer sold; verify.|48000
...
Elite Trader Funding|1-Step (Live Trailing, intraday)|50000|2000|INTRADAY|0|3000|NT/Rithmic/Tradovate. Locks at start+$100 after safety net. Cap 8 minis. Start+$100 lock NOT re-verified against Elite's own docs - check it.|50100|8
Elite Trader Funding|1-Step (Live Trailing, intraday)|100000|3000|INTRADAY|0|6000|NT/Rithmic/Tradovate. Locks at start+$100 after safety net. Cap 14 minis. Start+$100 lock NOT re-verified against Elite's own docs - check it.|100100|14
Elite Trader Funding|1-Step (Live Trailing, intraday)|150000|5000|INTRADAY|0|9000|NT/Rithmic/Tradovate. Locks at start+$100 after safety net. Cap 18 minis. Start+$100 lock NOT re-verified against Elite's own docs - check it.|150100|18
Elite Trader Funding|End of Day (EOD trailing)|50000|2000|EOD|1100|3000|NT/Rithmic/Tradovate. Locks at start+$100 after safety net. Cap 8 minis. Start+$100 lock NOT re-verified against Elite's own docs - check it.|50100|8
Elite Trader Funding|End of Day (EOD trailing)|100000|3500|EOD|2200|6000|NT/Rithmic/Tradovate. Locks at start+$100 after safety net. Cap 14 minis. Start+$100 lock NOT re-verified against Elite's own docs - check it.|100100|14
Elite Trader Funding|Static (fixed floor)|10000|500|EOD|0|1000|NT/Rithmic/Tradovate. Fixed floor, never trails. Cap 1 mini. Start+$100 lock NOT re-verified against Elite's own docs - check it.|9500|1
